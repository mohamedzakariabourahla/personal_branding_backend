...
public class TikTokOAuthApplicationService {
    ...
    public PlatformConnection completeAuthorization(Long userId, String state, String code) {
        ...
        var tokens = tikTokApiClient.exchangeCodeForTokens(code, oauthState.getRedirectUri(), oauthState.getCodeVerifier());
        var user = tikTokApiClient.fetchUser(tokens.accessToken());
