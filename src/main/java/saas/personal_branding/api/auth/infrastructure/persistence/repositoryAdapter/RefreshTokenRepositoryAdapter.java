...
import saas.personal_branding.api.auth.infrastructure.mapping.RefreshTokenEntityMapper;
...
public class RefreshTokenRepositoryAdapter implements RefreshTokenRepository {
    ...
    public List<RefreshToken> findActiveByUserId(Long userId) {
        return jpaRefreshTokenRepository.findActiveByUserIdOrderByLastUsedAtDesc(userId, java.time.Instant.now())
                .stream()
                .map(RefreshTokenEntityMapper::toDomain)
                .toList();
    }
