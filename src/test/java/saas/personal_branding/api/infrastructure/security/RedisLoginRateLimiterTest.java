...
class RedisLoginRateLimiterTest {
    ...
    void setUp() {
        ...
        limiter = new RedisLoginRateLimiter(redisTemplate, clock, 3, Duration.ofMinutes(15), new SimpleMeterRegistry());
    }
    ...
    void blocksAfterExceedingMaxAttempts() {
        ...
        limiter.recordFailure(key);
        assertThrows(UserException.TooManyLoginAttemptsException.class, () -> limiter.checkAllowed(key));
    }
